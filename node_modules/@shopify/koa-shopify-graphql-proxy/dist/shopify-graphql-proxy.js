...
exports.GRAPHQL_PATH = '/admin/api/graphql';
function shopifyGraphQLProxy(ctx, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, session, accessToken, shop;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = ctx.session, session = _a === void 0 ? {} : _a;
                    accessToken = session.accessToken, shop = session.shop;
                    if (!(ctx.path !== exports.PROXY_BASE_PATH)) return [3 /*break*/, 2];
                    return [4 /*yield*/, next()];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
